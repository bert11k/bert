<template>
  <div class="createUser">
    ...
    <h2>Добавить работника</h2>
      ...
      <input placeholder="Телефон" required type="tel" v-model="phone"><br>
      <input placeholder="Рабочий телефон" required type="tel" v-model="phoneWork"><br>
      <input placeholder="Должность" required type="text" v-model="position"><br>
      <button type="submit">Добавить пользователя</button><br>
    </form>
  </div>
</template>

    ...
    <div v-else>
      <div>
        ...
        <div class="table">
          ...
          <div class="line" v-for="deal of deals" :key="deal.key">
            <h4>
              <router-link to="/reportdeal">{{deal.title}}</router-link>
            </h4>
            <h4>{{deal.customer}}</h4>
            <h4>{{deal.date}}</h4>
            <div>
              <h4 v-for="subj of deal.subjects" :key="subj.title">{{subj.title}}</h4>
            </div>
            <h4>{{deal.profit}}р.</h4>
          </div>
        </div>
